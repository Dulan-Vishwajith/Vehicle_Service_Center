...
try {
    $stmt = $pdo->prepare("
        SELECT
            b.id, b.vehicle_model, b.license_plate, b.booking_date, b.status,
        ...
        WHERE b.assigned_assistant_id = ?
          ...
          AND b.status IN ('confirmed', 'service')
        GROUP BY b.id, b.vehicle_model, b.license_plate, b.booking_date, b.status, u.name, ts.start_time, ts.end_time
